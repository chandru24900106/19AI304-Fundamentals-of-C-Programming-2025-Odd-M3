...
```
# Output:
<img width="507" height="182" alt="image" src="https://github.com/user-attachments/assets/81a99baa-7db1-4e5c-925e-9d1d934fff61" />
...
{
    int a[10][10], m;
    int i, j, k, min, max, row, col, found = 0;
...
```
# Output:
<img width="451" height="312" alt="image" src="https://github.com/user-attachments/assets/48ddc328-9430-4882-ba41-2c6589df1a3c" />
...
```
# Output:
<img width="472" height="206" alt="image" src="https://github.com/user-attachments/assets/289a7469-cc39-44b5-9dfb-7e3380a33d67" />
...
```
# Output:
<img width="468" height="282" alt="image" src="https://github.com/user-attachments/assets/477b2dc9-2867-4acf-bc9d-8d9ea1a51daa" />
...
```
# Output:
<img width="660" height="222" alt="image" src="https://github.com/user-attachments/assets/1c970509-758e-43d4-9ad9-affdeb6fa358" />
